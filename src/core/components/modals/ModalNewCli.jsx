        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div className="fixed inset-0 transition-opacity" aria-hidden="true">
                    <div className="absolute inset-0 bg-slate-700/70 bg-opacity-10" onClick={() => setShowModal(false)}></div>
                </div>
                        ...
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className="mt-4 space-y-4">
                                    <div>
                                        <label htmlFor="user-name" className="block text-sm font-medium text-gray-300">
                                            Nombre completo
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label htmlFor="user-email" className="block text-sm font-medium text-gray-300">
                                            Correo electrónico
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div>
                                        <label htmlFor="user-password" className="block text-sm font-medium text-gray-300">
                                            Contraseña
                                        </label>
                                        <input
                                            type="password"
                                    ...
                                    <div>
                                        <label htmlFor="user-role" className="block text-sm font-medium text-gray-300">
                                            Rol
                                        </label>
                                        <select
                                            id="user-role"
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="create-license" className="ml-2 block text-sm text-gray-300">
